...
public class IncometaxCalculator {
	...
	public static void main(String[] args) {
		...
		//compute tax payable using a  nested -if 4cases
		...
		System.out.printf("the income tax playble is: %.2f",taxPayable);
		//System.out.print("the income tax playble is "+ frm.format(taxPayable));
